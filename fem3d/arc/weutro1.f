...
c        write(9,'(3(f8.4,2x))') GP1,DP1, RESP 	!ggu
      ...
      CD (4, ISEG) = (GP1 - DP1-GRZ)*PHYT*VOL
      RETURN
      END
	subroutine zoop
	implicit none
...
c
	  zoosk = (1-EFF)*GRZ*PHYT + KDZ*ZOO
	else
	  GRZ = K1G*ZOO*ZOOSG(ISEG)	!original formulation
	  zoosk =GRZ 
	end if

	 CD (9, ISEG) = (EFF*GRZ*PHYT-KDZ*ZOO)*VOL
