...
c actual used values may be lower
	...
	integer nbdydim			!points for lagrange model

	!parameter (nkndim=6000)
	!parameter (neldim=12000)
	parameter (nkndim=2000)
	parameter (neldim=4000)
	parameter (nlvdim=50)
	parameter (mbwdim=220)
	parameter (ngrdim=11)
	parameter (nbcdim=30)
