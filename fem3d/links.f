...
!	-------------------------------------------------
	...
	!write(6,*) 'looking for k1=',k1,iep_last
	  if( iep_last == 0 ) exit
	  iep = iep_last
	  nloop = nloop + 1
        end do
	...
	!write(6,*) 'first found - before sort ------------'
	!write(6,*) k,n,iep
	!write(6,*) list
...
!****************************************************************
	...
	write(6,*) 'finished fixing: ',kn,kantv(:,kn)
