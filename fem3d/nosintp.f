...
c interpolation matrix
	...
	parameter (lat0=43.5)		! lower left point of matrix
	parameter (lon1=14.0)		! upper right point of matrix
	parameter (lat1=46.0)		! upper right point of matrix
	parameter (dlon=2./60.)		! grid spacing (longitude)
	parameter (dlat=2./60.)		! grid spacing (latitude)
...
c	  call prchar(cc,nx,ny)
	  call writec(cm,nx,ny,it,l,ivar)
	end do
...
c***************************************************************
	...
	subroutine writec(cm,ip,jp,it,l,ivar)
