...
c
c \newcommand{\VERSION}{7.5.50}
c \newcommand{\version}{7\_5\_50}
c \newcommand{\COMMIT}{2018-10-24}
c
c DOCS	END

        implicit none

        character*10, parameter :: version = '7.5.50'
        character*10, parameter :: commit  = '2018-10-24'
