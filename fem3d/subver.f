...
c
c \newcommand{\VERSION}{7.5.67}
c \newcommand{\version}{7\_5\_67}
c \newcommand{\COMMIT}{2020-01-29}
c
c DOCS	END

        implicit none

        character*10, parameter :: version = '7.5.67'
        character*10, parameter :: commit  = '2020-01-29'
