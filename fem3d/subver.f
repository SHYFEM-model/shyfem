...
c
c \newcommand{\VERSION}{7.5.52}
c \newcommand{\version}{7\_5\_52}
c \newcommand{\COMMIT}{2018-12-19}
c
c DOCS	END

        implicit none

        character*10, parameter :: version = '7.5.52'
        character*10, parameter :: commit  = '2018-12-19'
