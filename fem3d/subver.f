...
c
c \newcommand{\VERSION}{7.5.77}
c \newcommand{\version}{7\_5\_77}
c \newcommand{\COMMIT}{2022-04-13}
c
c DOCS	END
	...
	logical, save		:: bshort = .false.
        ...
        character*10, parameter :: version = '7.5.77'
        character*10, parameter :: commit  = '2022-04-13'
