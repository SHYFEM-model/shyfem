...
c
c \newcommand{\VERSION}{7.5.68}
c \newcommand{\version}{7\_5\_68}
c \newcommand{\COMMIT}{2020-02-14}
c
c DOCS	END

        implicit none

        character*10, parameter :: version = '7.5.68'
        character*10, parameter :: commit  = '2020-02-14'
