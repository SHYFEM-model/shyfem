...
c
c \newcommand{\VERSION}{7.5.80}
c \newcommand{\version}{7\_5\_80}
c \newcommand{\COMMIT}{2022-05-19}
c
c DOCS	END
	...
	logical, save		:: bshort = .false.
        ...
        character*10, parameter :: version = '7.5.80'
        character*10, parameter :: commit  = '2022-05-19'
