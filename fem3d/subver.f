...
c
c \newcommand{\VERSION}{7.5.60}
c \newcommand{\version}{7\_5\_60}
c \newcommand{\COMMIT}{2019-02-28}
c
c DOCS	END

        implicit none

        character*10, parameter :: version = '7.5.60'
        character*10, parameter :: commit  = '2019-02-28'
