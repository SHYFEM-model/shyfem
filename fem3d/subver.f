...
c
c \newcommand{\VERSION}{7.5.66}
c \newcommand{\version}{7\_5\_66}
c \newcommand{\COMMIT}{2019-12-19}
c
c DOCS	END

        implicit none

        character*10, parameter :: version = '7.5.66'
        character*10, parameter :: commit  = '2019-12-19'
