...
c
c \newcommand{\VERSION}{7.5.51}
c \newcommand{\version}{7\_5\_51}
c \newcommand{\COMMIT}{2018-11-09}
c
c DOCS	END

        implicit none

        character*10, parameter :: version = '7.5.51'
        character*10, parameter :: commit  = '2018-11-09'
