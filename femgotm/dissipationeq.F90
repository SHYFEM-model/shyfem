...
!$Id: dissipationeq.F90,v 1.10 2007-01-06 11:49:15 kbk Exp $
#include"cppdefs.h"
!-----------------------------------------------------------------------
!BOP
!
...
# ifdef DEBUG_GGU
	call save_gotm_int('after_diff',0)
	call save_gotm_int('nlev',nlev)
	call save_gotm_int('psi_ubc',psi_ubc)
	call save_gotm_int('psi_lbc',psi_lbc)
	call save_gotm_val('dt',dt)
	call save_gotm_val('cnpar',cnpar)
	call save_gotm_val('DiffEpsup',DiffEpsup)
	call save_gotm_val('DiffEpsdw',DiffEpsdw)
	...
	call save_gotm_array('eps',nlev,eps)
# endif
...
# ifdef DEBUG_GGU
	call save_gotm_int('dissip',0)
	call save_gotm_int('nlev',nlev)
	call save_gotm_val('cde',cde)
	call save_gotm_val('ce3',ce3)
	call save_gotm_array('tke',nlev,tke)
	call save_gotm_array('tkeo',nlev,tkeo)
	call save_gotm_array('eps',nlev,eps)
	call save_gotm_array('L',nlev,L)
	call save_gotm_array('Lsour',nlev,Lsour)
	call save_gotm_array('Qsour',nlev,Qsour)
	call save_gotm_array('sig_eff',nlev,sig_eff)
	call save_gotm_array('num',nlev,num)
# endif
