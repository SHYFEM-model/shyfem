!$Id: tkeeq.F90,v 1.9 2005-11-15 11:35:02 lars Exp $
#include"cppdefs.h"
!-----------------------------------------------------------------------
!BOP
!
...
# ifdef DEBUG_GGU
        ...
        call save_gotm_val('z0s',z0s)
        call save_gotm_val('z0b',z0b)
        call save_gotm_val('u_taus',u_taus)
        call save_gotm_val('u_taub',u_taub)
        call save_gotm_val('tke_nlev',tke(nlev))
        call save_gotm_val('tke_0',tke(0))
        call save_gotm_val('DiffKup',DiffKup)
        call save_gotm_val('DiffKdw',DiffKdw)
        call save_gotm_array('P',nlev,P)
        call save_gotm_array('B',nlev,B)
