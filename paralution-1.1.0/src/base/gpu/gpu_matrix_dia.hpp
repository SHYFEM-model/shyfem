...
#ifndef PARALUTION_GPU_MATRIX_DIA_HPP_
#define PARALUTION_GPU_MATRIX_DIA_HPP_
...
class GPUAcceleratorMatrixDIA : public GPUAcceleratorMatrix<ValueType> {

public:

  GPUAcceleratorMatrixDIA();
  GPUAcceleratorMatrixDIA(const Paralution_Backend_Descriptor local_backend);
...
#endif // PARALUTION_GPU_MATRIX_DIA_HPP_
