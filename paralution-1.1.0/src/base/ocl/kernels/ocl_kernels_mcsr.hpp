...
const char *ocl_kernels_mcsr =
	"__kernel void kernel_mcsr_spmv_scalar(         const IndexType nrow,\n"
	...
	"}\n"
	"\n"
	"__kernel void kernel_mcsr_add_spmv_scalar(         const IndexType nrow,\n"
	"                                          __global const IndexType *row_offset,\n"
	"                                          __global const IndexType *col, __global const ValueType *val,\n"
