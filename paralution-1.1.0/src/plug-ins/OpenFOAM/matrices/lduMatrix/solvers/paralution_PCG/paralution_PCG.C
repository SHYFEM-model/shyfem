// **************************************************************************
//
//    Modification of file paralution_PCG.C is made by the PARALUTION Labs
//    team, this file is a part of the PARALUTION library.
//
...
// **************************************************************************
//
// The origin OpenFOAM license (file PCG.C):
//
/*---------------------------------------------------------------------------*\
  =========                 |
...
#include "paralution_PCG.H"

// * * * * * * * * * * * * * * Static Data Members * * * * * * * * * * * * * //

namespace Foam
{
    defineTypeNameAndDebug(paralution_PCG, 0);

    lduMatrix::solver::addsymMatrixConstructorToTable<paralution_PCG>
        addparalution_PCGSymMatrixConstructorToTable_;
}


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::paralution_PCG::paralution_PCG
(
...
) const
{
    ...
    if (!solverPerf.checkConvergence(tolerance_, relTol_)) {
      ...
      paralution::CG<paralution::LocalMatrix<double>,
