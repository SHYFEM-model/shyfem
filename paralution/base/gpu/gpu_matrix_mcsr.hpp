...
#ifndef PARALUTION_GPU_MATRIX_MCSR_HPP_
#define PARALUTION_GPU_MATRIX_MCSR_HPP_
...
class GPUAcceleratorMatrixMCSR : public GPUAcceleratorMatrix<ValueType> {

public:

  GPUAcceleratorMatrixMCSR();
  GPUAcceleratorMatrixMCSR(const Paralution_Backend_Descriptor local_backend);
  virtual ~GPUAcceleratorMatrixMCSR();
...
#endif // PARALUTION_GPU_MATRIX_MCSR_HPP_
