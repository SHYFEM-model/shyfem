...
!	double precision ruv(nkndim), rvv(nkndim)       !momentum input (2D)
!       common /ruv/ruv, /rvv/rvv

!       double precision crad(neldim)                       !$$GWI (radiation)
!       common /crad/crad
...
!       save /ruv/,/rvv/,/crad/
	...
	integer, private, save :: nkn_bnd_aux = 0
        ...
        double precision, allocatable, save :: rvv(:)
        double precision, allocatable, save :: ruv(:)
        double precision, allocatable, save :: crad(:)
