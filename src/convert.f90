...
! function ialfa(value,string,ndec,mode)	converts double precision number into alpha
!
...
!	module scan
!
!	character*1,  parameter, private :: blank = ' '
!	character*1,  parameter, private :: tab = '	'
!	character*1,  parameter, private :: comma = ','
!	character*1,  parameter, private :: plus = '+'
!	character*1,  parameter, private :: minus = '-'
!	character*1,  parameter, private :: dot = '.'
!	character*4,  parameter, private :: expont = 'eEdD'
!	character*10, parameter, private :: number = '1234567890'
!
!	contains
!
!****************************************************************
...
!	istell=idigit(value,ndec)       !(ROUND)
...
!	if( ndec .gt. 0 ) then
	...
	zahl = zahl * fact
!	if( zahl .gt. 0. ) then	!ggu changed 3/5/2001 to avoid -0.0
...
! izahli, izahlf	numbers of i/f part
	...
	if(ndec.gt.0) then
		izf=ndec
		ifact=10**ndec
!		izahli=(zahl*ifact+.5)/ifact    !(ROUND)
