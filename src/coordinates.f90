...
! 10.01.2012    ggu     bug fix: c_param was double precision
...
!==================================================================
        ...
        double precision, allocatable, save :: xgeov(:)
        double precision, allocatable, save :: ygeov(:)
        double precision, allocatable, save :: xcartv(:)
        double precision, allocatable, save :: ycartv(:)
...
! gets coordinates x/y for element ie
        ...
        integer, intent(in)	 	:: ie
        double precision, intent(out), dimension(3) :: x, y
