...
!====================================================
	...
	implicit none
        ...
        double precision, allocatable, save :: hkv(:)
        double precision, allocatable, save :: hev(:)

        double precision, allocatable, save :: hkv_min(:)
        double precision, allocatable, save :: hkv_max(:)
