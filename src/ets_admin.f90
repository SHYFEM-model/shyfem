...
! 30.05.2015    ggu     new read from STR file, using module ets
!
!******************************************************************
!******************************************************************
!******************************************************************
...
! writes and administers ets file
	...
	if( icall .eq. 0 ) then
		...
		call ets_setup
                ...
                call ets_write_header2(nbext,ilets,hlv,hets,nkets,xets,yets,chets,ierr)
	...
	if ( bwave ) then
	  ...
	  waves2(4,:) = waved
	  il4kv = nvars
	  call routets(nvars,il4kv,waves2,outets)
...
! extracts nodal information and stores it in array
	...
	integer ilhkv(1)
	double precision value(nlv,1)
	double precision out(nlv,1)
