	...
	!save /tken_gotm/,/eps_gotm/,/rls_gotm/
        ...
        !double precision shearf2(nlvdim,nkndim)
        !common /shearf2/shearf2
        
	!double precision buoyf2(nlvdim,nkndim)
	...
	!save /shearf2/,/buoyf2/
        ...
        double precision, allocatable, save :: shearf2(:,:)
        double precision, allocatable, save :: buoyf2(:,:)
