	...
	double precision, allocatable, save :: ulov(:,:)
	double precision, allocatable, save :: ulnv(:,:)
	double precision, allocatable, save :: vlov(:,:)
	double precision, allocatable, save :: vlnv(:,:)
	double precision, allocatable, save :: wlov(:,:)
	double precision, allocatable, save :: wlnv(:,:)
