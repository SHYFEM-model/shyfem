	...
	implicit none
        ...
        double precision, allocatable, save :: rdistv(:)
        double precision, allocatable, save :: fcorv(:)
        double precision, allocatable, save :: fxv(:,:)
        double precision, allocatable, save :: fyv(:,:)
        double precision, allocatable, save :: momentxv(:,:)
        double precision, allocatable, save :: momentyv(:,:)
        double precision, allocatable, save :: iuvfix(:)
