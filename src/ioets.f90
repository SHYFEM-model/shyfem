!
! $Id: subets.f,v 1.15 2007-03-20 13:14:53 georg Exp $
!
...
! please note that the file has still to be closed manually
	...
	call findets_err(iunit,'delets','File is not open, cannot close.',n)
...
! should be only used to write file -> nvers should be max version
	...
	call findets_err(iu_from,'ets_clone_params','Cannot find entry.',nf)
	call findets_err(iu_to,'ets_clone_params','Cannot find entry.',nt)
...
!************************************************************
	...
	subroutine ets_read_header2(iu,ilhkv,hlv,hkv,nodes,xg,yg,desc,ierr)
...
! reads second record of ETS file
	...
	double precision hkv(1)
	integer nodes(1)
	double precision xg(1),yg(1)
	character*80 desc(1)
	integer ierr
...
!************************************************************
	...
	subroutine ets_write_header2(iunit,ilhkv,hlv,hkv,nodes,xg,yg,desc,ierr)
...
!************************************************************
	...
	if( ierr .ne. 0 ) return
	call ets_read_header2(-iunit,ilhkv,hlv,hkv,nodes,xg,yg,desc,ierr)
