!
! $Id: subflx.f,v 1.15 2007-03-20 13:14:53 georg Exp $
!
...
!************************************************************
	...
	subroutine infoflx(iunit,nvers,nsect,kfluxm,idtflx,nlmax)

! reads first info record of FLX file
!
...
!*********************************************************
	...
	subroutine flx_read_header(iunit,nscddi,nfxddi,nlvddi,nvers     &
     &				,nsect,kfluxm,idtflx,nlmax,kflux,nlayers)
	...
	call rfflx(iunit,nvers,nscddi,nfxddi,nlvddi,nsect,kfluxm,idtflx,nlmax,kflux,nlayers)

	end

!*********************************************************

	subroutine flx_read_record(iunit,nvers,it,nlvddi,nsect,ivar,nlayers,fluxes,ierr)
...
!*********************************************************
	...
	subroutine flx_write_header(iunit,nvers,nsect,kfluxm,idtflx,nlmax,kflux,nlayers)
	...
	call wfflx(iunit,nvers,nsect,kfluxm,idtflx,nlmax,kflux,nlayers)

	end

!*********************************************************

	subroutine flx_write_record(iunit,nvers,it,nlvddi,nsect,ivar,nlayers,fluxes)
...
!************************************************************
	...
	subroutine rfflx(iunit,nvers,nscddi,nfxddi,nlvddi,nsect,kfluxm,idtflx,nlmax,kflux,nlayers)
...
!********************************************************************
	...
	subroutine wfflx(iunit,nvers,nsect,kfluxm,idtflx,nlmax,kflux,nlayers)
...
! local
	...
	if( nvers .le. 2 ) then
          read(iunit,end=88,err=99) it,nsect,(fluxes(0,1,i),i=1,nsect)  &
     &                  ,(fluxes(0,2,i),fluxes(0,3,i),i=1,nsect)
	else if( nvers .le. 4 ) then
          read(iunit,end=88,err=99) it,nsect,(nlayers(i)        &
     &                  ,((fluxes(l,j,i),l=0,nlayers(i)),j=1,3),i=1,nsect)
	else if( nvers .ge. 5 ) then
          read(iunit,end=88,err=99) it,nsect,ivar,(nlayers(i)   &
     &                  ,((fluxes(l,j,i),l=0,nlayers(i)),j=1,3),i=1,nsect)
	else
...
! local
	integer i,l,j
        ...
        write(iunit) it,nsect,ivar,(nlayers(i),((fluxes(l,j,i),l=0,nlayers(i)),j=1,3),i=1,nsect)
