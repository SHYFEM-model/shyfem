...
!==================================================================
	...
	!---------------------------------------------
        ...
        type  :: lagr_entry
          ...
          double precision    :: xst                        !initial x-coordinate
          double precision    :: yst                        !initial y-coordinate
          double precision    :: zst                        !initial z-coordinate
          double precision    :: x                          !x-coordinate
          double precision    :: y                          !y-coordinate
          double precision    :: z                          !z-coordinate
          double precision    :: c                          !custom property for plot
          double precision    :: tin                        !time of release
	...
	!---------------------------------------------
        ...
        double precision, save :: azlgr                     !az parameter
        double precision, save :: tdecay                    !decay time - do not use
        double precision, save :: fall                      !vertical sinking velocity
        double precision, save :: rwhpar                    !horizontal diffusivity

	!---------------------------------------------
	! horizontal diffusivity
	!---------------------------------------------

        double precision, save, allocatable :: rwhvar(:)    !horizontal diffusivity (vary)
	...
	!---------------------------------------------
        ...
        double precision, save, allocatable :: u_lag(:)      !backtracking x-velocity
        double precision, save, allocatable :: v_lag(:)      !backtracking y-velocity
        double precision, save, allocatable :: x_back(:)     !backtracking x-coordinate
        double precision, save, allocatable :: y_back(:)     !backtracking y-coordinate
        double precision, save, allocatable :: z_back(:)     !backtracking z-coordinate

	!--------------------------------------------------
	! fluxes and velocities
	!--------------------------------------------------

        double precision, save, allocatable :: flux2d(:,:)      !fluxes of sides
        double precision, save, allocatable :: flux3d(:,:,:)    !fluxes of sides (3d)
        double precision, save, allocatable :: vel_ie(:,:)      !velocities of sides
        double precision, save, allocatable :: vel3d_ie(:,:,:)  !velocities of sides (3d)
        double precision, save, allocatable :: dvert(:,:)
