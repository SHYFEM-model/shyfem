!
! $Id: lagrange_main.f,v 1.5 2010-03-11 15:36:38 georg Exp $
!
...
! -------------------------------------------
! check for initialization from file.lgr 
!---------------------------------------------
...
! ilagr = 2	2d lagrangian (not implemented)
...
! advection of particles
	...
	double precision dt,ttime,tmax
...
!**********************************************************************
	...
	use basin, only : nkn,nel,ngr,mbw
        ...
        integer ilhv(neldim)
        common /ilhv/ilhv
        double precision hev(neldim)
        common /hev/hev
        double precision hlv(1)
        common /hlv/hlv

        double precision aux(neldim)
        double precision aux_t(neldim)
        double precision aux_r(neldim)
        ...
        call wheos(iunit,nvers,nkn,nel,nlv,nvar,ilhv,hlv,hev,title)
        endif
