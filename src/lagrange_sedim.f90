...
!
! simulates lagrangian sediment transport
!
! revision log :
!
! 06.05.2015    ccf	written from scratch
!
!*******************************************************************
!================================================================
        module lagrange_sedim
!================================================================
        ...
        double precision, allocatable             :: gs(:)     !particle grain size [mm]
        double precision, allocatable             :: fr(:)     !fraction of sediment type [0-1]
...
! called by subroutine lgr_set_properties
	...
	double precision, intent(out)             :: sg	!sediment grainsize
