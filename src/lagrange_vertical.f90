...
! returns vertical velocity to be used in lagrangian model
	...
	double precision z0		!depth of particle
	...
	double precision a_in	!relative postion of side is_in [0-1]
	double precision a_out	!relative postion of side is_out [0-1]
	double precision w		!computed vertical velocity for ie and l0 (return)
...
! returns vertical velocity at point given by ie,l0,is,a
	...
	double precision a		!relative postion of side
	double precision w		!computed vertical velocity for ie and l0 (return)

	include 'param.h'

	integer ii,k1,k2
	double precision wo1,wo2,wn1,wn2
...
! computes layer thickness for element ie
	...
	double precision hl(lmax)		!layer thickness (return)
...
!*******************************************************************
	...
	double precision zn0		!initial relative vertical position in layer
	double precision deltat		!time spent in element(horizontal)
	double precision w			!average vertical velocity
	double precision zn1		!final relative vertical position in layer
	double precision ztime		!time spent in element (vertical)
        integer addl		!relative movement to next layer [-1,0,+1]
        double precision layd		!layer thickness
...
!************************************************************
	...
	double precision d			!relative distance from closest vertex
	integer near		!number of closest vertex [1-3]
	integer far		!to be deleted...
	double precision re			!relative distance to first point of side
