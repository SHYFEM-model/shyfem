...
!==================================================================
        ...
        double precision, save, allocatable :: hlv(:)
        double precision, save, allocatable :: hldv(:)
...
!==================================================================
	...
	integer nkn,nel,nl
        ...
        if( nkn == nkn_levels .and. nel == nel_levels .and. nl == nlv_levels ) return
...
! re-allocates arrays depending on nl
	...
	double precision, allocatable :: hldv_aux(:)
