...
!============================================================
	...
	double precision, allocatable, save :: z0bk(:)	!bottom roughness on nodes
	double precision, allocatable, save :: z0sk(:)	!surface roughness on nodes

	double precision, parameter :: z0bmin = 1.e-4
	double precision, parameter :: z0smin = 0.02

	double precision, parameter :: z0bini = 0.03*0.03
	double precision, parameter :: z0sini = 0.02
