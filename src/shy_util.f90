...
!****************************************************************
	...
	subroutine shy_write_output_record(id,dtime,ivar,n,m,nlv,nlvdi,c)
...
!****************************************************************
	...
	integer nlvddi
	double precision z(*)
	double precision ze(3,*)
	double precision u(nlvddi,*)
	double precision v(nlvddi,*)
