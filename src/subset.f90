!
! $Id: mod_subset.f,v 1.4 2009-04-03 16:38:23 georg Exp $
!
! routines to create subset
!
! contents :
!
! revision log :
!
! 01.09.2015	eps	code written from scratch
...
!$    timer = omp_get_wtime()
      ...
      call greedy_subset(start,numsubset,subset_lenght,subset,nel,max_l,min_l)
...
!***********************************************************
      ...
      subroutine greedy_subset(start,numsubset,subset_lenght,subset,nel,max_l,min_l)
