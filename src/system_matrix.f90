...
!==================================================================
	...
	integer, save :: n3max = 0
        ...
        integer, allocatable, save :: i2coo_glob(:)
        integer, allocatable, save :: j2coo_glob(:)
        integer, allocatable, save :: displs_coo(:)
        integer, allocatable, save :: n2_local(:)
        double precision, allocatable, save :: c2coo(:)
        double precision, allocatable, save :: c2coo_glob(:)
        integer, allocatable, save :: index_coo(:)
...
!==================================================================
        ...
        subroutine mod_system_init(nkn,nel,ngr,mbw,nlv,nprocs)
...
!****************************************************************
   ...
   subroutine alloc_c2c_glob(gdim,grdim)

      implicit none

      integer gdim,grdim

      allocate(i2coo_glob(gdim))
      allocate(j2coo_glob(gdim))
      allocate(c2coo_glob(gdim))
      allocate(displs_coo(grdim))
