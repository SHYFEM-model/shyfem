!
! $Id: subnsa.f,v 1.21 2009-09-14 08:20:58 georg Exp $
!
! ap utility routines
!
! contents :
...
! revision log :
!
! revised on 25.11.88 by ggu (no parameter, merged sp158k and randk)
! revised on 30.11.88 by ggu (no array ig,iamat any more)
! revised on 08.10.90 by ggu (kantv is ordened with direction)
...
! iunit		unit number of file
	...
	if(iu.eq.0) then
!		write(6,*) 'error reading parameter file'
!		write(6,*) 'parameters initialized to default values'
		return
	end if
