...
! 
! in clo_add/set/get_option numbers can be integer, double precision or double precision
...
!==================================================================
	...
	INTERFACE clo_add_option
        MODULE PROCEDURE clo_add_option_r, clo_add_option_i, &
     &			 clo_add_option_f, clo_add_option_s
	END INTERFACE

	INTERFACE clo_set_option
        MODULE PROCEDURE clo_set_option_r, clo_set_option_i, &
     &			 clo_set_option_f, clo_set_option_s
	END INTERFACE

	INTERFACE clo_get_option
        MODULE PROCEDURE clo_get_option_r, clo_get_option_i, &
...
!**************************************************************
	...
	write(6,*) 'Usage: ',routine_name(1:nr),' [-h|-help] [-options] ',files_name(1:nf)
